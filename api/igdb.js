// api/igdb.js  ✅ COPY-PASTE (kein sort, daher KEIN 406)
// -> Vercel: Datei genau so anlegen: /api/igdb.js
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // ✅ WICHTIG: KEIN sort benutzen wenn search benutzt wird
    const body = `
      search "${q.replace(/"/g, '\\"')}";
